...
- 👤 Different types of players with unique strategies (**Gracz**)
...
## Example Flow
1. Create a lottery central and initialize 10 vendors.  
2. Generate 200 players of each available player type.  
3. Simulate 20 consecutive lottery draws with players purchasing tickets.  
4. Players automatically verify their tickets and collect any winnings.  
5. Print simulation reports: draw history, payouts, taxes collected, and subsidies received.  
6. Run all project tests using Maven:  
   ```bash
   mvn test
